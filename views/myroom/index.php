...
<script>
    function createZoomLink(param) {
        ...
        var xhr = new XMLHttpRequest();
        xhr.open('GET', 'https://e-osvita.online/api/createdatazoom?paramzoom=' + datazoom + '&iddatazoom=' + iddatazoomid, true);
        xhr.onload = function () {
            var obj = JSON.parse(this.responseText);
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="list-group">
                <span class="list-group-item active">Список в інтервалі дат</span>
                <div class="rasp" style="overflow: scroll;
...
<div class="modal fade bd-example-modal-sm" id="openModalAddUser" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">&nbsp;
            ...
            <input class="form-control" id="dataticheradd0" list="list-ticher0" style=""
                   placeholder="Предмет вчителя"/>
            ...
            <p>
                <input class="form-control" id="ticher_class_number" onchange="" list="list-ticher_class_number"
                       style=""
                       placeholder="Цифра (класний керівник)"/>
                <datalist id="list-ticher_class_number">
                    <option>1</option>
                    <option>2</option>
                    <option>3</option>
                    <option>4</option>
            ...
            <p>
                <input class="form-control" id="ticher_class_latter" onchange="" list="list-ticher_class_latter"
                       style=""
                       placeholder="Літера (класний керівник)"/>
                <datalist id="list-ticher_class_latter">
                    <option>А</option>
                    <option>Б</option>
                    <option>В</option>
                    <option>Г</option>
            ...
            <div class="modal-footer">
                <center>
                    ...
                    <?php } ?>
                    <button type="button" class="btn btn-danger" onclick="openModalTest();"
...
<div id="useridadd" style="display: none;"></div>
<div class="modal fade bd-example-modal-sm" id="openModalAddPredmetTicher" tabindex="-1" role="dialog"
     aria-labelledby="mySmallModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">&nbsp;
            <h5 class="modal-title">&nbsp;Оберіть додатковий предмет</h5>
            <input class="form-control" id="dataticheradd100" list="list-ticher100" style=""
                   placeholder="Предмет вчителя"/>
            <datalist id="list-ticher100">
                <option>Українська мова</option>
                <option>Літературне читання</option>
                <option>Англійська мова</option>
                <option>Я у світі</option>
            ...
            <div class="modal-footer">
                <center>
                    ...
                    if (Yii::$app->user->id != 9 && Yii::$app->user->id != 10 && Yii::$app->user->id != 11) {
                        ?>
                        <button type="submit" class="btn btn-success" onclick="AddTicherPredmet();">Додати</button>
                    <?php } ?>
...
<script>
    function RedactUsers(id) {
        var response_id = id;
        document.getElementById("useridadd").innerHTML = response_id;
        $("#openModalUserSelect").modal('hide');
        $("#openModalAddPredmetTicher").modal('show');
    }

    function AddTicherPredmet() {
        var predmet = document.getElementById('dataticheradd100').value;
        let user_ticher_id = $("#useridadd").html();
        var xhr = new XMLHttpRequest();
        xhr.open('GET', 'https://e-osvita.online/api/namepredmetticheradd?predmet=' + predmet + '&ticher_user_id=' + user_ticher_id, true);
        xhr.onload = function () {
            alert("Предмет додано ...");
            $("#openModalAddPredmetTicher").modal('hide');
        }
        xhr.send(null);
    }
</script>
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="form-group">
                ...
                <?php if ($model["tipe"] != 4) { ?>
                <div class="form-group" style="margin-left:60px; margin-top:-22px;">
                    <input list="rasp_predmet_respons" class="form-control"
                           style="margin-left:2px; margin-left:-20px;" id="rasp_predmet" placeholder="Предмет"/>
                    <datalist id="rasp_predmet_respons">
                        <span id="rasp_predmet_respons"></span>
                    </datalist>
                </div>
            </div>
            <script>
                function TicherRespondPredmet() {
                    var xhr = new XMLHttpRequest();
                    var id = <?php  echo $id ?>;
                    xhr.open('GET', 'https://e-osvita.online/apirozklad/ticherrespondpredmet?user_id=' + id, true);
                    xhr.onload = function () {
                        // openModalRaspisanieCreate();
                        // closeModalRaspisanieCreate();
                        document.getElementById("rasp_predmet_respons").innerHTML = this.responseText;
                    };
                    xhr.send(null);
                }
            </script>
            ...
            <?php if ($model["tipe"] == 4) { ?>
            <div class="form-group" style="margin-left:60px; margin-top:-22px;">
                <input list="rasp_predmet_responstu" class="form-control"
                       style="margin-left:2px; margin-left:-20px;" id="rasp_predmet" placeholder="Предмет"/>
                <datalist id="rasp_predmet_responstu">
                    <option>Українська мова</option>
                    <option>Літературне читання</option>
                    <option>Англійська мова</option>
                    <option>Я у світі</option>
...
<div class="row row-offcanvas row-offcanvas-right">
    ...
    border: 2px solid #2e6da4; color: #ffffff; margin-top: 3px; font-size: 19px;">&nbsp;Розклад на: <?php echo $today = date("d.m.Y"); ?>&nbsp;</span>
            <?php } ?>
    ...
    margin-bottom: 1px;
    background-color: #2e6da4;
    border: 2px solid #2e6da4; color: #ffffff; margin-top: 3px; font-size: 19px;">&nbsp;Сьогодні: <?php echo $today = date("d.m.Y"); ?>&nbsp;</span>
            ...
            <?php if ($model["tipe"] == 4 or $model["tipe"] == 1) { ?>
                <button type="button" style="width:100%; border: 1px solid #c0c0c0; font-size:16px;" onclick="openWindowAdmin();"
                        class="openbtn "><span
                            style="margin-left: -26px;">Адмін
                        розділ</span>
                </button>
                <div class="dropdown">
  ...
  <path fill-rule="evenodd"
        d="M15 14s1 0 1-1-1-4-5-4-5 3-5 4 1 1 1 1h8zm-7.978-1h7.956a.274.274 0 0 0 .014-.002l.008-.002c-.002-.264-.167-1.03-.76-1.72C13.688 10.629 12.718 10 11 10c-1.717 0-2.687.63-3.24 1.276-.593.69-.759 1.457-.76 1.72a1.05 1.05 0 0 0 .022.004zM11 7a2 2 0 1 0 0-4 2 2 0 0 0 0 4zm3-2a3 3 0 1 1-6 0 3 3 0 0 1 6 0zM6.936 9.28a5.88 5.88 0 0 0-1.23-.247A7.35 7.35 0 0 0 5 9c-4 0-5 3-5 4 0 .667.333 1 1 1h4.216A2.238 2.238 0 0 1 5 13c0-1.01.377-2.042 1.09-2.904.243-.294.526-.569.846-.816zM4.92 10c-1.668.02-2.615.64-3.16 1.276C1.163 11.97 1 12.739 1 13h3c0-1.045.323-2.086.92-3zM1.5 5.5a3 3 0 1 1 6 0 3 3 0 0 1-6 0zm3-2a2 2 0 1 0 0 4 2 2 0 0 0 0-4z"/>
            ...
            <?php if ($model["tipe"] == 2 or $model["tipe"] == 4) { ?>
                ...
                <div class="modal fade bd-example-modal-sm" id="openModalJurnalPredmet" tabindex="-1" role="dialog"
                     aria-labelledby="mySmallModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-sm">
                        <div class="modal-content">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">X</button>
                            <div class="modal-header" style="border-bottom: 0px solid #e5e5e5;">
                                <p class="modal-title" id="exampleModalLongTitle">Оберіть предмет</p>&nbsp;
                                <div class="row">
                                    <form>
                                        <div class="col-xs-6">
                                            <div class="form-group">
                                                <div class="input-group date">
                                                    <input class="form-control" onchange="goDataSearchPredmet();"
                                                           id="zavuch_predmet" list="list-ticher_predmet" style=""
                                                           placeholder="Предмет вчителя"/>
                                                    <datalist id="list-ticher_predmet">
                                                        <option>Українська мова</option>
                                                        <option>Літературне читання</option>
                                                        <option>Англійська мова</option>
                                                        <option>Я у світі</option>
                                                    ...
                                                    <span class="input-group-addon"><svg
  ...
  <path d="M10.97 4.97a.235.235 0 0 0-.02.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-1.071-1.05z"/>
                ...
                <script>
                    function goDataSearchPredmet() {
                        var predmet = document.getElementById('zavuch_predmet').value;
                        var xhr = new XMLHttpRequest();
                        xhr.open('GET', 'https://e-osvita.online/apijornal/respondjurnalzavuch?predmet=' + predmet, true);
                        xhr.onload = function () {
                            document.getElementById('tableJurnalStart').style.display = 'none';
                            document.getElementById("responseJornalZavuch").innerHTML = this.responseText;
                        };
                        xhr.send(null);
                    }

                    function openJurnalZavuchPredmet() {
                        $("#openModalJurnalPredmet").modal('show');
                    }
                </script>


                <div class="modal fade bd-example-modal-sm" id="openModalJurnalClass" tabindex="-1" role="dialog"
                     aria-labelledby="mySmallModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-sm">
                        <div class="modal-content">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">X</button>
                                ...
                                <div class="row">
                                    <form>
                                        <div class="col-xs-6">
                                            <div class="form-group">
                                                <div class="input-group date">
                                                    <input list="number-list-number" class="form-control"
                                                           id="zavuch_number" placeholder="Буква класса"/>
                                                    <datalist id="number-list-number">
                                                        <option value="1">1</option>
                                                        <option value="2">2</option>
                                                        <option value="3">3</option>
                                                        <option value="4">4</option>
  ...
  <path d="M10.97 4.97a.235.235 0 0 0-.02.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-1.071-1.05z"/>
                                        ...
                                        <div class="col-xs-6">
                                            <div class="form-group">
                                                <div class="input-group date">
                                                    <input list="number-list-latter" class="form-control"
                                                           id="zavuch_latter" onchange="goDataSearchClass();"
  ...
  <path d="M10.97 4.97a.235.235 0 0 0-.02.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-1.071-1.05z"/>
                ...
                <script>
                    function goDataSearchClass() {
                        var classnumber = document.getElementById('zavuch_number').value;
                        var classlater = document.getElementById('zavuch_latter').value;
                        var xhr = new XMLHttpRequest();
                        xhr.open('GET', 'https://e-osvita.online/apijornal/respondjurnalzavuch?number_class=' + classnumber + '&letter_class=' + classlater, true);
                        xhr.onload = function () {
                            document.getElementById('tableJurnalStart').style.display = 'none';
                            document.getElementById("responseJornalZavuch").innerHTML = this.responseText;
                        };
                    ...
                    function openJurnalZavuchClassSearch() {
                        $("#openModalJurnalClass").modal('show');
                    }
                </script>
                <div class="modal fade bd-example-modal-sm" id="openModalJurnalZavuch" tabindex="-1" role="dialog"
                     aria-labelledby="mySmallModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-sm">
                        <div class="modal-content">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">X</button>
                                        ...
                                        <div class="col-xs-6">
                                            <div class="form-group">
                                                <div class="input-group date">
                                                    <input type="date"
                                                           title="Щоб обрати дату, натисніть иконку календаря в цьому полі"
                                                           id="datejurnal20" class="form-control"/>
                                                    <span class="input-group-addon">Дата</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xs-6">
                                            <div class="form-group">
                                                <div class="input-group date">
                                                    <input type="date"
                                                           title="Щоб обрати дату, натисніть иконку календаря в цьому полі"
                                                           id="datejurnal30" onchange="goDataSearchJurnalZavuch();"
                                                           class="form-control"/>
                                                    <span class="input-group-addon">Дата</span>
                                                </div>
                                            </div>
                ...
                <script>
                    function goDataSearchJurnalZavuch() {
                        var data1 = document.getElementById('datejurnal20').value;
                        var data2 = document.getElementById('datejurnal30').value;
                        var xhr = new XMLHttpRequest();
                        xhr.open('GET', 'https://e-osvita.online/apijornal/respondjurnalzavuch?date1=' + data1 + '&date2=' + data2, true);
                        xhr.onload = function () {
                    ...
                    function openJurnalZavuch() {
                        $("#openModalJurnalZavuch").modal('show');
                    }
                </script>
            <?php } ?>
            <?php if ($model["tipe"] == 3 or $model["tipe"] == 2) { ?>
            ...
            <?php if ($model["tipe"] == 4 or $model["tipe"] == 1 or $model["tipe"] == 2) { ?>
                ...
                <script>
                    function RedactRaspisanie() {
                        ...
                        var xhr = new XMLHttpRequest();
                        xhr.open('GET', 'https://e-osvita.online/api/responseraspisanie?parametr1=' + rasp_respond_date + '&parametr2=redact');
                        xhr.onload = function () {
                            //var obj = JSON.parse(this.responseText);
                            console.log(this.responseText);
            ...
            <?php if ($model["tipe"] == 3) { ?>
                <div class="dropdown">
                    <button class="openbtn " style="width:100%; border: 1px solid #c0c0c0; font-size:16px;"
                            type="button"
                            data-toggle="dropdown"><span id="count_new_test"><span style="margin-left: -25px;">Твої тести</span></span><span class="caret"></span>
                    </span></button>
                    <ul class="dropdown-menu" style="min-width: 100%;">
                        <form>
                            <script></script>
    ...
    <script>
        function goDataSearchUser() {
            ...
            let dateYear20 = new Date().getFullYear(date20);
            let dateMonth20 = new Date().getMonth(date20) + 1;
            let dateDay20 = new Date(date20);
            var chislovan = dateDay20.getDate();
            var date30 = document.getElementById('date30').value;
            let dateYear30 = new Date().getFullYear(date30);
            let dateMonth30 = new Date().getMonth(date30) + 1;
            let dateDay30 = new Date(date30);
            var chislotu = dateDay30.getDate();
            var url = 'date1=' + dateYear20 + '-' + dateMonth20 + '-' + chislovan + '&date2=' + dateYear30 + '-' + dateMonth30 + '-' + chislotu;
            console.log(url);
            window.location.replace("jornal?" + url);
        }
    ...
    <?php } ?>
    <?php if ($model["tipe"] == 2) { ?>
        <div class="rasp" style="background-color: #ffffff; height:430px; overflow-x: hidden;">
            <table class="table table_sort">
                <thead>
                <tr>
                    <td colspan="4" style="background-color: #c4e2ff; "><span style="margin-left: -5px;">Журнал</span></td>
                </tr>
                <tr>
                    <th>#</th>
                    <th>Клас&nbsp;▼</th>
                ...
                <tbody>
                <?php foreach ($jornal_data as $jornal_value) {
                    echo '<tr>
                        <td >1</td>
                        <td>' . $jornal_value["classnumber_id"] . '-' . $jornal_value["classlater_id"] . '</td>
                        <td><a style=" text-decoration: underline;" href="/myroom/jornal?numberclass=' . $jornal_value["classnumber_id"] . '&literaclass=' . $jornal_value["classlater_id"] . '&school=' . $jornal_value["school_id"] . '">Відкрити</a></td>
                    </tr>';
                } ?>
                </tbody>
            </table>
    ...
    <?php if ($model["tipe"] == 3) { ?>
                            ...
                            <div class="col-xs-6">
                                <div class="form-group">
                                    <div class="input-group date" id="datetimepicker10">
                                        <input type="date"
                                               title="Щоб обрати дату, натисніть иконку календаря в цьому полі"
                                               id="date_van" class="form-control"/>
                                        <span class="input-group-addon">Дата</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xs-6">
                                <div class="form-group">
                                    <div class="input-group date">
                                        <input type="date"
                                               title="Щоб обрати дату, натисніть иконку календаря в цьому полі"
                                               id="date_tu" onchange="openModalTestsIntervalResponseAll()" ;
                                               class="form-control"/>
                                        <span class="input-group-addon">Дата</span>
                                    </div>
                                </div>
        ...
        <table>
            ...
            <tr style=" font-size: 22px;  ">
                ...
                <td style="background-color: #bdb0a3; border-radius: 4px; ">&nbsp;<a href="#"
                                                                                     style="color: #3C3A3A;">По
                        предмету</a>&nbsp;
                </td>
            </tr>
            </tbody>
        ...
        <div class="rasp" style="background-color: #ffffff; height:420px; overflow-x: hidden;">
            <table class="table table_sort">
                <thead>
                <tr>
                    <td colspan="5" style="background-color: #c4e2ff; ">Журнал</td>
                </tr>
                <tr>
                    <th scope="col">#</th>
                ...
                <tbody>
                <tr>
                    <?php foreach ($jornal as $valjornal) {
                        echo '<tr>
                        <td scope="row">1</td>
                         <td scope="row">' . $valjornal["datetimeurok"] . '</td>
                        <td>' . $valjornal["name_predmet"] . '</td>
                         <td>' . $valjornal["ocenka"] . '</td>
    ...
    <?php if ($model["tipe"] == 4) { ?>
        ...
        <table>
            ...
            <tr style=" font-size: 22px;  ">
                <td style="background-color: #bbb0d9; border-radius: 4px; ">&nbsp;<a href="#"
                                                                                     onclick="openJurnalZavuch();"
                                                                                     style="color: #3C3A3A;">За
                        період</a>&nbsp;
                </td>
                <td style="background-color: #bdb0a3; border-radius: 4px; ">&nbsp;<a href="#"
                                                                                     onclick="openJurnalZavuchClassSearch();"
                                                                                     style="color: #3C3A3A;">По
                        класу</a>&nbsp;
                </td>
                <td style="background-color: #afcdb7; border-radius: 4px; ">&nbsp;<a href="#"
                                                                                     onclick="openJurnalZavuchPredmet();"
        ...
        <script>    function SortJurnalDate() {
                $("#openModalSortJurnalData").modal('show');
            }</script>
        <script>document.addEventListener('DOMContentLoaded', () => {
                const getSort = ({target}) => {
        ...
        <div id="responseJornalZavuch"></div>

        <div id="tableJurnalStart" class="rasp" style="background-color: #ffffff; height:320px; overflow-x: hidden;">
            <table class="table table_sort">
                <thead>
                <tr>
...
<script>
    ...
    function DisplayVisibleBlock(parametr1, parametr2) {
        ...
        xhr.open('GET', 'https://e-osvita.online/api/visibleraspisanie?parametr1=' + date_urok + '&parametr3=' + active_urok, true);
        xhr.onload = function () {
    ...
    function CreateUser() {
        ...
        var direct_class_number = document.getElementById('ticher_class_number').value;
        var direct_class_later = document.getElementById('ticher_class_latter').value;

        xhr.open('GET', 'https://e-osvita.online/api/createuseradd?parametr1=' + firstname + '&parametr2=' + lastname + '&parametr3=' + otchestvo + '&parametr4=' + email + '&predmet0=' + predmet0 + '&number=' + direct_class_number + '&latter=' + direct_class_later, true);
        xhr.onload = function () {
            var obj = JSON.parse(this.responseText);
            alert();
            if (obj.respond == 1) {
    ...
    function fetchai() {
        fetch('https://e-osvita.online/api/fetch')
