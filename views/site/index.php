    ...
    <div class="jumbotron" style="color: #ffffff; ">
        ...
        <tr>
            ...
            if( strpos($_SERVER['HTTP_USER_AGENT'],'MSIE')!==false ||
                ...
                echo'<td><a class="btn btn-lg btn-success" href="/site/login">&nbsp;&nbsp;Розпочати&nbsp;&nbsp;&nbsp;</a></td><td><a href="/site/presentation"><button type="button" class="btn btn-primary" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;О нас&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</button></td></a>';
            }
            ?>
        </tr>
    </div>
...
<!--LiveInternet counter--><span style="display: none;"><a href="https://www.liveinternet.ru/click"
                              target="_blank"><img id="licnt531F" width="88" height="31" style="border:0"
                                                   ...
                                                   alt=""/></a><script>(function(d,s){d.getElementById("licnt531F").src=
